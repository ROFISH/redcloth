%%{
  ...
  # textile modifiers
  A_LEFT = "<" %{ UNLESS_DISABLED_ATTRIBUTE(align,ATTR_SET("align", "left");) } ;
  A_RIGHT = ">" %{ UNLESS_DISABLED_ATTRIBUTE(align,ATTR_SET("align", "right");) } ;
  A_JUSTIFIED = "<>" %{ UNLESS_DISABLED_ATTRIBUTE(align,ATTR_SET("align", "justify");) } ;
  A_CENTER = "=" %{ UNLESS_DISABLED_ATTRIBUTE(align,ATTR_SET("align", "center");) } ;
  A_PADLEFT = "(" >A %{ ATTR_INC("padding-left"); } ;
  A_PADRIGHT = ")" >A %{ ATTR_INC("padding-right"); } ;
